#este ejercicio es similar a uno realizado en el repositorio de apuntes que hice días antes del examen.
#cuyo nombre es  (apuntes_parcial) y cuyo link es:
...
#apreciamos que se encripta el código
